...
## 4. Instalar um Display Manager (LXDM ou SDDM)

Escolha **apenas um** display manager para instalar e habilitar.

### 4.1 LXDM — leve e tradicional (recomendado para máquinas simples)
...
> Nota:  
> LXDM é simples, rápido e consome poucos recursos.  
> SDDM oferece melhor suporte visual, temas e integração com ambientes Qt.
