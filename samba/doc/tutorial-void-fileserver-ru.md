...
## 🔧 Сетевая лаборатория с QEMU/Virtmanager и Proxmox. Настройте руководство в соответствии с вашей средой.
...
## 🧭 Установить адрес DNS — укажите PDC.
